...
var driverRef = firebase.database().ref("StaticDriverLocation/l");
...
//Get firebase coords
firebase.database().ref('/StaticDriverLocation/l').on('value', function(snapshot) {
...
function search_user()
{
	...
	if(document.getElementById('objectId').value > 0)
